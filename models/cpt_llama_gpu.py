...
def main():
    ...
    args.tokenizer.pad_token = "<|finetune_right_pad_id|>"
    
    assert args.tokenizer.pad_token_id == 128004
    assert args.tokenizer.eos_token_id == 128009
    assert args.tokenizer.pad_token_id != args.tokenizer.eos_token_id
